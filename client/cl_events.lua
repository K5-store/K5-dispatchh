...
RegisterNetEvent('K5-dispatch:client:drugsale', function()
    DrugSale()
end)
...
RegisterNetEvent("K5-dispatch:client:officerdown", function ()
    OfficerDown()
end)
...
RegisterNetEvent("K5-dispatch:client:emsdown", function ()
    EmsDown()
end)
